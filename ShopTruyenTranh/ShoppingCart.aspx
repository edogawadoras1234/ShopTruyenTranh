<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="ShopTruyenTranh.ShoppingCart" %>
...
Convert.ToDouble(Item.TruyenTranh.GiaTruyen)))%>
 </ItemTemplate>
 </asp:TemplateField>
